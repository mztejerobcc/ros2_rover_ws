...
#include "rvr_msgs/msg/detail/vector3__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rvr_msgs::msg::Vector3;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const rvr_msgs::msg::Vector3 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rvr_msgs::msg::Vector3 *>(
    untyped_ros_message);
...
{
  return &rvr_msgs::msg::typesupport_fastrtps_cpp::_Vector3__handle;
}
