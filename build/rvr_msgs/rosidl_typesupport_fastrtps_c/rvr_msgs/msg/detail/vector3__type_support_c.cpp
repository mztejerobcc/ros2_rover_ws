...
#include "rvr_msgs/msg/detail/vector3__rosidl_typesupport_fastrtps_c.h"
...
using _Vector3__ros_msg_type = rvr_msgs__msg__Vector3;
...
static uint32_t _Vector3__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rvr_msgs__msg__Vector3(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rvr_msgs__msg__Vector3;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _Vector3__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rvr_msgs__msg__Vector3(
