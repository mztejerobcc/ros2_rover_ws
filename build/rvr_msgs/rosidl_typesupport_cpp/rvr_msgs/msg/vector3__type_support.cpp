...
static const _Vector3_type_support_symbol_names_t _Vector3_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rvr_msgs, msg, Vector3)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rvr_msgs, msg, Vector3)),
  }
};
...
{
  return &::rvr_msgs::msg::rosidl_typesupport_cpp::Vector3_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rvr_msgs, msg, Vector3)() {
  return get_message_type_support_handle<rvr_msgs::msg::Vector3>();
}
