...
bool rvr_msgs__msg__vector3__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rvr_msgs.msg._vector3.Vector3", full_classname_dest, 29) == 0);
  }
  rvr_msgs__msg__Vector3 * ros_message = _ros_message;
  {  // x
...
PyObject * rvr_msgs__msg__vector3__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rvr_msgs.msg._vector3");
